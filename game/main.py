...
Run with CTRL+T (Thonny) or with the run.bat file, currently contains game loop setup, 
utility labels and interface tests. If _curses module missing, run pip install windows-curses 
in windows terminal.
